...
@section("content")
    ...
    <script>
        ...
        document.getElementById('images').addEventListener('change', function(e) {
            ...
            // Remove warning about replacing images (no longer relevant)
            ...
            if (files.length > 0) {
                ...
                preview.className = 'image-preview mt-6';
