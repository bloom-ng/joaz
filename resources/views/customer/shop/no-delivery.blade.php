...
<body class="bg-[#FCFCFC] text-[#212121]">
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-row font-rustler text-4xl items-center justify-center pt-24 py-12">select pickup location</div>

        <div class="flex justify-center px-16 pb-20">
            <div class="flex flex-col border border-[1px] border-[#21212199]/30 font-bricolage w-2/5 rounded-2xl p-8 items-center gap-8">
                <h2 class="font-bold text-2xl">2/2</h2>
                <div class="relative w-full">
                    <div class="flex flex-row items-center justify-between w-full font-bricolage border border-[#21212199]/30 rounded-lg p-4 bg-transparent cursor-pointer" onclick="toggleDropdown()">
                        <span id="selected-option">Pickup location</span>
                    ...
                    <div id="dropdown-menu" class="hidden absolute w-full mt-1 bg-white border border-[#21212199]/30 rounded-lg shadow-lg z-10">
                        <a href="#" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100" onclick="selectOption('Shop no BPF14, First Floor, Old Banex Plaza, Wuse 2, Abuja, Nigeria'); event.preventDefault();">Shop no BPF14, First Floor, Old Banex Plaza, Wuse 2, Abuja, Nigeria</a>
                    </div>
                </div>
                <button style="background: linear-gradient(91.36deg, #85BB3F 0%, #212121 162.21%);"
                        class="text-[#FCFCFC] text-sm px-10 py-5 rounded-lg w-full">
                    PROCEED
                </button>
            </div>
        </div>
