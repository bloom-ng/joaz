                ...
                @if (isset($randomCategoryProducts) && $randomCategoryProducts->count() > 0)
                    @foreach ($randomCategoryProducts as $product)
                        <div class="flex text-left flex-col gap-2">
                            ...
                            <p class="text-md font-bricolage">{{ $product->description ?: "Premium quality product" }}
                            </p>
                            <div class="-mt-3 flex flex-row justify-between">
                                ...
                                @endif
                                <a href="{{ route("shop.productDetails", $product->id) }}"
                                    class="text-md font-semibold font-bricolage border-b-[1px] border-[#212121] hover:text-gray-600">
                                    SHOP
                                </a>
                            </div>
                        </div>
